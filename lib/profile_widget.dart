                ...
                Container(
                  ...
                  StackedArea100Series<VisitingClassData, String>(
                    dataSource: <VisitingClassData>[
                      VisitingClassData(1, random.nextInt(10) + 30),
                      VisitingClassData(2, random.nextInt(10) + 30),
                      VisitingClassData(3, random.nextInt(10) + 30),
                      VisitingClassData(4, random.nextInt(10) + 30),
                      VisitingClassData(5, random.nextInt(10) + 30),
                      VisitingClassData(6, random.nextInt(10) + 30),
                      VisitingClassData(7, random.nextInt(10) + 30),
                      VisitingClassData(8, random.nextInt(10) + 30),
                      VisitingClassData(9, random.nextInt(10) + 30),
                      VisitingClassData(10, random.nextInt(10) + 30),
                    ],
                    name: 'Пропуски',
