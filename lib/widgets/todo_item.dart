              ...
              child: Row(
                ...
                children: <Widget>[
                  Flexible(
                    child: Text(
                      todo.descrizione,
                      style: TextStyle(decoration: todo.done ? TextDecoration.lineThrough : null, fontWeight: FontWeight.w400, fontSize: _queryData.textScaleFactor * 16, color: Colors.black),
                    ),
                  ),
                  Checkbox(
                    ...
                    value: todo.done,
                    onChanged: (newValue) {
                      BlocProvider.of<TodoListBloc>(context).add(UpdateTodo(todo: Todo(descrizione: todo.descrizione, id: todo.id, ordering: todo.ordering, done: newValue)));
                    },
                  ),
                ],
              ),
